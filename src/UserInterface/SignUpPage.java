...
public class SignUpPage extends JPanel{
    ...
    public SignUpPage(){
        ...
        JPanel p_personalInfo1Parent = new JPanel(new FlowLayout());
        JPanel p_personalInfo1headerAndBody = new JPanel(new BorderLayout());
        ...
        JPanel p_personalInfo1 = new JPanel(new GridLayout(3,2));
        ...
        JPanel p_firstname = new JPanel(new FlowLayout());
        JPanel p_firstnameMini = new JPanel(new BorderLayout());
        ...
        JPanel p_lastname = new JPanel(new FlowLayout());
        JPanel p_lastnameMini = new JPanel(new BorderLayout());
        ...
        JPanel p_emailMini = new JPanel(new BorderLayout());
        ...
        JPanel p_country = new JPanel(new FlowLayout());
        JPanel p_countryMini = new JPanel(new BorderLayout());
        ...
        JPanel p_DobTitle = new JPanel(new FlowLayout());
        // p_DobTitle.setBorder(new EmptyBorder(0,150,0,0));
        JPanel p_DobTitleMini = new JPanel(new BorderLayout());
        JPanel p_dobMini = new JPanel(new BorderLayout());
        ...
        JPanel p_titleMini = new JPanel(new BorderLayout());
        ...
        JPanel p_personalInfo2Parent = new JPanel(new FlowLayout());
        JPanel p_personalInfo2headerAndBody = new JPanel(new BorderLayout());
        ...
        JPanel p_personalInfo2 = new JPanel(new GridLayout(1,2));
        p_personalInfo1.setBorder(new LineBorder(Color.GREEN, 2));

        JLabel lbl_perosnalInfo2 = new JLabel("Security Info:");
        lbl_perosnalInfo2.setFont(new Font("MuseoSans-900", Font.BOLD, 32));

        JPanel p_username = new JPanel(new FlowLayout());
        JPanel p_usernameMini = new JPanel(new BorderLayout());
        ...
        JPanel p_password = new JPanel(new FlowLayout());
        JPanel p_passwordMini = new JPanel(new BorderLayout());
        ...
        JPanel p_submitButton = new JPanel(new FlowLayout(FlowLayout.CENTER));
